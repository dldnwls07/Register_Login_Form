...
const LoginForm = ({ onLoginSuccess }) => {  const [formData, setFormData] = useState({
    usernameOrEmail: '',
    password: '',
  });
    ...
    <div className="auth-form-container">
      ...
      <form className="auth-form" onSubmit={handleSubmit}>
        ...
        <div className="form-options auto-login-option">
          <div className="remember-me">
            <label>
              <input type="checkbox" name="autoLogin" /> 계속 반복하시겠습니까?
            </label>
          </div>
          <span className="auto-login-info">7일 동안 자동 로그인됩니다</span>
        </div>

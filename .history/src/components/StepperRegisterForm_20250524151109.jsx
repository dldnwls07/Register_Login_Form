        ...
        return (
          <div className="form-group" role="group" aria-labelledby="username-label">
            ...
            <input
              ...
              onKeyDown={handleKeyDown}              placeholder="3자 이상의 아이디를 입력하세요"
              disabled={isLoading}
              className={`form-input ${errors.username ? 'input-error' : formData.username.length >= 3 ? 'input-success' : ''}`}
              aria-invalid={!!errors.username}
              aria-describedby={errors.username ? 'username-error' : 'username-help'}
            />              <div className="input-status">
                <small id="username-help" className="input-help">
                  {!formData.username && "영문, 숫자를 포함한 3자 이상의 아이디를 입력해주세요"}

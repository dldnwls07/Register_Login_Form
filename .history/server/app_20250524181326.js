...
// Monkey-patch: SequelizeStore가 Sequelize 클래스를 찾을 수 있도록 인스턴스에 직접 할당
if (sequelize && Sequelize) {
  sequelize.Sequelize = Sequelize;
} else {
  console.error("CRITICAL ERROR: Sequelize instance or Sequelize class is not available for monkey-patching.");
  process.exit(1);
}
...
const sessionStore = new SequelizeStore({
  ...
  table: 'sessions', // 세션 테이블 이름
  Sequelize: Sequelize, // Sequelize 클래스 생성자 명시적 전달

...
exports.sendVerificationCode = async (req, res) => {
    try {
        console.log('⭐️ 이메일 인증코드 발송 요청 받음:', req.body);
...
exports.verifyEmailCode = (req, res) => {
    try {
        console.log('⭐️ 인증코드 확인 요청 받음:', req.body);
...
exports.sendOtp = async (req, res) => {
    console.log('⭐️ sendOtp API 호출됨:', req.body);
...
exports.verifyOtp = (req, res) => {
    console.log('⭐️ verifyOtp API 호출됨:', req.body);
    exports.verifyEmailCode(req, res);
};

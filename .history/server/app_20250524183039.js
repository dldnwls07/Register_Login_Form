...
// console.log('DEBUG: typeof sequelize.define:', typeof sequelize.define); // 주석 처리
// console.log('DEBUG: sequelize.constructor.DataTypes:', sequelize.constructor.DataTypes); // 주석 처리

// 세션 저장소 설정 (Sequelize 사용)
const sessionStore = new SequelizeStore({
  db: sequelize, // 필수 옵션
  // table: 'sessions', // 기본값 사용 (Sessions 또는 Session)
  // checkExpirationInterval: 15 * 60 * 1000, // 기본값 사용
  // expiration: 24 * 60 * 60 * 1000 // 기본값 사용
});

// console.log('DEBUG: sessionStore.model:', sessionStore.model); // 주석 처리
